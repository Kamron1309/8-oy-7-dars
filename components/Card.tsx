...
const Card: React.FC<CardProps> = ({ 
  ...
  return (
    <div
      className={`
        p-5 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700
    ...
    >
      ...
      <div className="w-full h-[3px] bg-gray-100 dark:bg-gray-700 mt-4 rounded-full overflow-hidden">
